...
import com.irisapp.domain.triggers.TriggerCatalog
import com.irisapp.platform.capability.PackageCapabilityScanner
import com.irisapp.platform.tools.reto.CapabilityBinder
import com.irisapp.platform.tools.reto.CoverageValidator
import com.irisapp.platform.tools.reto.RequirementStatus
import com.irisapp.platform.tools.reto.RetoOrchestrator
import com.irisapp.platform.tools.reto.RetoTrace
import com.irisapp.platform.tools.reto.TaskDecomposer
...
class RetoWorkflowPlanner(
    ...
    private suspend fun buildRequestAnalysisFromFacts(
        ...
        val prompt = buildString {
            appendLine("You are a request analyzer for IrisApp.")
            appendLine()
  ...
  "missing_info": [...]
    ...
    private suspend fun buildActionPlanFromFacts(
        ...
        val prompt = buildString {
            appendLine("You are an action planner for IrisApp.")
    ...
    private suspend fun repairWorkflowJsonWithModel(
        ...
        val prompt = buildString {
            appendLine("You are a strict JSON repair agent for IrisApp.")
  ...
  "missing_setup": []
    ...
    data class RetoWorkflowResult(
        ...
        val trace: RetoTrace,
        val ledger: com.irisapp.platform.tools.reto.RequirementLedger,
