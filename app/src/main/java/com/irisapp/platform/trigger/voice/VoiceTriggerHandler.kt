 ...
 * planner used by [com.irisapp.ui.home.WorkflowGenerationViewModel]),
    ...
    fun generateFromTranscript(
        ...
        scope.launch {
            try {
                ...
                val analysis = com.irisapp.domain.planner.RequestAnalysisParser.parse(result.analysisRaw)
                ...
                val resolvableIds = capabilityScanner.resolvableActions(
                    com.irisapp.domain.catalog.ActionSpecRegistry.allIds
                )
