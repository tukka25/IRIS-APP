package com.irisapp.platform.share
...
object ShareSheetTriggerHandler {
    ...
    private fun showNoWorkflowsNotification(context: Context, sharedContent: SharedContent) {
        ...
        val notification = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setStyle(NotificationCompat.BigTextStyle().bigText(
                ...
                "Shared: $summary\n\n" +
                "Open IrisApp to create a Share Sheet workflow."
            ))
    ...
    const val ACTION_RUN_SHARE_WORKFLOW = "com.irisapp.ACTION_RUN_SHARE_WORKFLOW"

    /** Action: display the pending shared content in the main screen. */
    const val ACTION_SHOW_SHARE_CONTENT = "com.irisapp.ACTION_SHOW_SHARE_CONTENT"

    /** Action: open the share workflow selector (for when user taps from notification). */
    const val ACTION_SHOW_SHARE_SELECTOR = "com.irisapp.ACTION_SHOW_SHARE_SELECTOR"
