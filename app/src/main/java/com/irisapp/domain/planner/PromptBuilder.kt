...
""".trimIndent()
    ...
    fun buildRequestAnalysisPrompt(
        ...
        appendLine("You are a request analyzer for IrisApp, an Android automation app.")
        appendLine()
...
You are an action planner for IrisApp, an Android automation app.
...
You are a JSON formatter for IrisApp. Convert the action plan into the final workflow JSON contract.
