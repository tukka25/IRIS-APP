 ...
 *  - The workflow will appear in the share sheet picker when content is shared to IrisApp
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(
                ...
                Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    FeatureRow(
                        emoji = "\uD83D\uDCE4",
                        text = "This workflow appears in the share sheet picker when you share content to IrisApp from any app."
                    )
                    FeatureRow(
                        emoji = "\u2705",
