package com.irisapp.platform.trigger.sound
...
class SoundEventTriggerService : Service() {
    ...
    private fun ensureNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = "Shows when IrisApp is listening for sound events"
                setShowBadge(false)
            }
    ...
    companion object {
        ...
        const val ACTION_START = "com.irisapp.action.START_SOUND_DETECTION"
        const val ACTION_STOP  = "com.irisapp.action.STOP_SOUND_DETECTION"
