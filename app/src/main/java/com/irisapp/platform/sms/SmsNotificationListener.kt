 ...
 *   Settings → Apps → IrisApp → Notification access → Allow
 */
class SmsNotificationListener : NotificationListenerService() {
    ...
    @Volatile
    private var cachedTriggerWorkflows: List<com.irisapp.domain.model.PlannedWorkflow> = emptyList()
    @Volatile
    ...
    private fun getTriggerWorkflows(): List<com.irisapp.domain.model.PlannedWorkflow> {
