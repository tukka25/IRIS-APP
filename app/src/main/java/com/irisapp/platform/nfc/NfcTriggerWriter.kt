 ...
 *
 * The tag stores a deep-link URI: iris://workflow/<workflowId>
 ...
 *
 * NDEF format:
 *   RTD_URI record containing "iris://workflow/<workflowId>"
...
class NfcTriggerWriter(
    ...
    companion object {
        ...
        const val SCHEME = "iris"
        const val AUTHORITY = "workflow"
        const val ACTION_NFC_SCANNED = "com.irisapp.platform.nfc.ACTION_NFC_SCANNED"
        const val EXTRA_WORKFLOW_ID = "workflow_id"

        // MIME type for iris:// records
        const val MIME_TYPE = "application/com.irisapp.workflow"
     ...
     * 1. RTD_URI record with iris://workflow/<workflowId>
     ...
     * iris:// is not a registered scheme with a prefix shortcut.
     */
